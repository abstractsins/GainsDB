...
export default function WorkoutCardDetails({
  exerciseName,
  exerciseData,
  exerciseCategory,
  onClose,
    ...
    <div className={`workout-card-details-body ${exerciseCategory}`}>
      {exerciseCategory !== null && (
        <span className="exercise-name">
          {" "}
          {toTitleCase(exerciseName || undefined)}{" "}
        </span>
      )}
        ...
        {exerciseData?.map((set) => {
          ...
          return (
            <li className="set" key={order}>
              ...
              <span className="set-weight">{Number(weight)}</span>
              <span className="unit">{weightUnit}</span>
              <span className="x">x</span>
              <span className="set-reps">{reps}</span>
              <span className="unit">{repUnit}</span>
            </li>
          );
        })}
      </ul>
